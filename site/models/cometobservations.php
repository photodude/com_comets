...
if (empty($list['direction']))
{
	...
	protected function getListQuery()
	{
		...
		if (!JFactory::getUser()->authorise('core.edit', 'com_comets'))
		{
		...
		if (!empty($search))
		{
			...
			else
			{
				...
				$query->where('( a.desg LIKE ' . $search . '  OR  a.diam LIKE ' . $search . '  OR  a.scope LIKE ' . $search . '  OR  a.comments LIKE ' . $search . ' )');
			}
		}
	...
	public function getItems()
	{
		...
		foreach ($items as $item)
		{
					...
					$item->location = JText::_('COM_COMETS_COMETOBSERVATIONS_LOCATION_OPTION_' . strtoupper($item->location));
		}
	...
	protected function loadFormData()
	{
		...
		if ($error_dateformat)
		{
			$app->enqueueMessage(JText::_("COM_COMETS_SEARCH_FILTER_DATE_FORMAT"), "warning");
